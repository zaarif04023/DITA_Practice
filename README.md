...
#Overview
This Projects illustarest a simple creation of DITA XML and a DITA map.
...
<p>The task topic demonstrates a basic explanation of how to achieve a certain result and the steps needed to get said result. 
  ...
  <ul>
    ...
    <li>Steps on how to install Coverity Connect</li>
    <li>An extra link to Black Duck documentation on how to install Coverity Connect </li>
  </ul>
  
  <h3>DITA Map </h3>
<p>The Map is simply acting like a table of contents Pointing the way to the other topics. 
  In this case, this map simply directs the user to either the</p>
  <ul>
    <li>Coverity Concept Page</li>
